...
#define SCALE_FACTOR (SCREEN_WIDTH / 1062.0f)

#define TITLE_HEIGHT (48.0f * SCALE_FACTOR)
#define PANEL_SPACING (25.0f * SCALE_FACTOR)
#define PANEL_WIDTH (250.0f * SCALE_FACTOR)
#define GAMEPAD_WIDTH (512.0f * SCALE_FACTOR)
#define GAMEPAD_HEIGHT (560.0f * SCALE_FACTOR)
#define BUTTON_MARGIN (16.0f * SCALE_FACTOR)
#endif
typedef struct
{
    bool m_bMoving;
